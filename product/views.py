...
def Invoice2(request):
	return render(request, 'product/Invoice2.html')

def InvoiceNew(request):
	return render(request, 'product/InvoiceNew.html')

def Tax1(request):
	return render(request, 'product/Tax1.html')

def Tax2(request):
	return render(request, 'product/Tax2.html')

def TaxNew(request):
	return render(request, 'product/TaxNew.html')
...
def GENINV3(request, *args,**kwargs):
	width, height = A4
	daystart = datetime.now().strftime('%d-%m-%Y')
	dayend = datetime.now().strftime('%d-%m-%Y')
	global month_collectInv
...
def GENTAX2(request):
	...
	### ==========> ลายเซน ===================================================================
	p.line(20 *mm, 25 *mm, 55 *mm, 25 *mm)
	ptext = Paragraph("<font size=10 name='supermarket' color='darkblue'>ผู้จ่ายเงิน</font>", styleN)
	ptext.wrapOn(p, width, height)
	ptext.drawOn(p, 32 *mm, 10 *mm)
...
def GENTAX3(request, *args,**kwargs):
	width, height = A4
	daystart = datetime.now().strftime('%d-%m-%Y')
	dayend = datetime.now().strftime('%d-%m-%Y')
	global month_collectTax
