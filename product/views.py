...
def Invoice1(request):
	return render(request, 'product/Invoice1.html')

def Tax1(request):
	return render(request, 'product/Tax1.html')
...
def GENPDF2(request):
	...
	link_image2 = 'https://www.c2premium.com/wp-content/uploads/2020/06/' + productID + '_pic_1.jpg'
	link_image3 = 'https://www.c2premium.com/wp-content/uploads/2020/06/' + productID + '_pic_2.jpg'
	link_image4 = 'https://www.c2premium.com/wp-content/uploads/2020/06/' + productID + '_pic_3.jpg'
	link_image5 = 'https://www.c2premium.com/wp-content/uploads/2020/06/' + productID + '_pic_4.jpg'
	link_image6 = 'https://www.c2premium.com/wp-content/uploads/2020/06/' + productID + '_draft_1.jpg'
...
def GENINV(request):
	...
	dayend = datetime.now().strftime('%d-%m-%Y')
	# sort number
	global month_collectInv
	if len(month_collectInv)<1:
		month_collectInv = []
		dateTimeObj = datetime.now()
		month = str(dateTimeObj.month)
		month_collectInv.append(month)
		i = len(month_collectInv)
	else:
		dateTimeObj = datetime.now()
		month = str(dateTimeObj.month)
		month_collectInv.append(month)
		i = len(month_collectInv)
		if month != month_collectInv[-2]:
			i = 0
			month_collect = []
			if len(month_collectInv)<1:
				month_collectInv = []
	...
	Quo_no = 'I' + str(dateTimeObj.year) + str(dateTimeObj.month) + numberQ
	response = HttpResponse(content_type='application/pdf')
	response['Content-Disposition'] = 'attachment; filename="Inv-{}.pdf"'.format(Quo_no)# re
	p = canvas.Canvas(response, pagesize=A4)
	BASE_DIR = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
	TTFSearchPath.append(str(BASE_DIR) + '/product')
	pdfmetrics.registerFont(TTFont('supermarket', "supermarket.ttf"))
	...
	# p.drawImage("https://drive.google.com/file/d/1IyG_Wpl4b8shMO3349uRcH9PeDhx45SU/view", 75, 240 * mm, width=30)
	### ==========> ผู้เสนอ ===================================================================
	ptext = Paragraph("<font size=28 name='supermarket' color='darkblue'>ใบแจ้งหนี้/INVOICE</font>", styleT)
	ptext.wrapOn(p, width, height)
	ptext.drawOn(p, 38 *mm, 280 *mm)
	...
	ptext = Paragraph("<font size=11 name='supermarket' color='darkblue'>INVOICE NO.</font>", styleN)
	ptext.wrapOn(p, width, height)
	ptext.drawOn(p, 130 *mm, 280 *mm)
	...
	### ==========> ลายเซน ===================================================================
	p.line(20 *mm, 25 *mm, 55 *mm, 25 *mm)
	ptext = Paragraph("<font size=10 name='supermarket' color='darkblue'>ผู้รับสินค้า</font>", styleN)
	ptext.wrapOn(p, width, height)
	ptext.drawOn(p, 32 *mm, 10 *mm)

	p.line(60 *mm, 25 *mm, 95 *mm, 25 *mm)
	ptext = Paragraph("<font size=10 name='supermarket' color='darkblue'>วันที่</font>", styleN)
	ptext.wrapOn(p, width, height)
	ptext.drawOn(p, 75 *mm, 10 *mm)
	...
	p.line(125 *mm, 25 *mm, 160 *mm, 25 *mm)
	ptext = Paragraph("<font size=10 name='supermarket' color='darkblue'>ผู้อนุมัติ</font>", styleN)
	ptext.wrapOn(p, width, height)
	ptext.drawOn(p, 140 *mm, 10 *mm)

	p.line(165 *mm, 25 *mm, 190 *mm, 25 *mm)
	ptext = Paragraph("<font size=10 name='supermarket' color='darkblue'>วันที่</font>", styleN)
	ptext.wrapOn(p, width, height)
	ptext.drawOn(p, 176 *mm, 10 *mm)
...
def GENTAX(request):
	...
	dayend = datetime.now().strftime('%d-%m-%Y')
	# sort number
	global month_collectTax
	if len(month_collectTax)<1:
		month_collectTax = []
		dateTimeObj = datetime.now()
		month = str(dateTimeObj.month)
		month_collectTax.append(month)
		i = len(month_collectTax)
	else:
		dateTimeObj = datetime.now()
		month = str(dateTimeObj.month)
		month_collectTax.append(month)
		i = len(month_collectTax)
		if month != month_collectTax[-2]:
			i = 0
			month_collect = []
			if len(month_collectTax)<1:
				month_collectTax = []
	...
	Quo_no = 'T' + str(dateTimeObj.year) + str(dateTimeObj.month) + numberQ
	response = HttpResponse(content_type='application/pdf')
	response['Content-Disposition'] = 'attachment; filename="Tax-{}.pdf"'.format(Quo_no)# re
	p = canvas.Canvas(response, pagesize=A4)
	BASE_DIR = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))
	TTFSearchPath.append(str(BASE_DIR) + '/product')
	pdfmetrics.registerFont(TTFont('supermarket', "supermarket.ttf"))
	...
	# p.drawImage("https://drive.google.com/file/d/1IyG_Wpl4b8shMO3349uRcH9PeDhx45SU/view", 75, 240 * mm, width=30)
	### ==========> ผู้เสนอ ===================================================================
	ptext = Paragraph("<font size=18 name='supermarket' color='darkblue'>ใบส่งสินค้า/ใบเสร็จรับเงิน/ใบกำกับภาษี</font>", styleT)
	ptext.wrapOn(p, width, height)
	ptext.drawOn(p, 38 *mm, 280 *mm)
	...
	ptext = Paragraph("<font size=11 name='supermarket' color='darkblue'>NO.</font>", styleN)
	ptext.wrapOn(p, width, height)
	ptext.drawOn(p, 130 *mm, 280 *mm)
	...
	### ==========> ลายเซน ===================================================================
	p.line(20 *mm, 25 *mm, 55 *mm, 25 *mm)
	ptext = Paragraph("<font size=10 name='supermarket' color='darkblue'>ผู้รจ่ายเงิน</font>", styleN)
	ptext.wrapOn(p, width, height)
	ptext.drawOn(p, 32 *mm, 10 *mm)
	...
	p.line(125 *mm, 25 *mm, 160 *mm, 25 *mm)
	ptext = Paragraph("<font size=10 name='supermarket' color='darkblue'>ผู้รับเงิน</font>", styleN)
	ptext.wrapOn(p, width, height)
	ptext.drawOn(p, 140 *mm, 10 *mm)
